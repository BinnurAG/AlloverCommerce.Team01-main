...
public class TC_03 {
    ...
    @Test(description = "US01 - TC03 The user should be able to register in toUpperCase")
    public void toUpperCaseTest() {
// Siteye müşteri olarak kayıt olurken username alanına sadece büyük harf girilebilmeli
        Driver.getDriver().get(ConfigReader.getProperty("alloverUrl"));
        p2_registerPage.register.click();
//        Username alanına sadece büyük harf gir
        p2_registerPage.userName.sendKeys("AAABBBBCCC");
