...
public class US_09_TC_10 {
    ...
    public void testName() {
        ...
        //Doğrulama "Good" veya "Strong" metin görünür
        String passwordStrengthText = P14_VendorRegisterPage.passwordStrength.getText();
        Assert.assertTrue(passwordStrengthText.contains("Good") || passwordStrengthText.contains("Strong"));
