...
public class US_09_TC_04 {
    ...
    public void testName() {
        ...
        //@işareti olmayan bir mail adresi gir
        p14_VendorRegisterPage.registrationEmail.sendKeys(ConfigReader.getProperty("registration_invalid_email2"));
        ...
        // ReusableMethods.screenShot("US_09_TC_04");
