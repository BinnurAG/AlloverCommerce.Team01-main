...
public class US_09_TC_03 {
    ...
    public void testName() {
        ...
        //Geçersiz bir e-posta adresi girin
        p14_VendorRegisterPage.registrationEmail.sendKeys(ConfigReader.getProperty("registration_invalid_email1"));
       ...
       // ReusableMethods.screenShot("US_09_TC_03");
