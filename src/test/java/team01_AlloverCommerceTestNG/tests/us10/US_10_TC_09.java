...
public class US_10_TC_09 {
    ...
    @Test
    public void PasswordLevelStrong() {
...
//Enter valid Re-Send Code in "Verification Code" box.
        ...
        ReusableMethods.waitForSecond(3);
        //Sayılar ve küçük harf içeren ve "Şifre" metin kutusuna büyük alfabetik karakterler içeren 7 karakterden fazla bir parola girin
        p14_VendorRegisterPage.password.sendKeys(ConfigReader.getProperty("strong_password"));
        //"Strong" metninin görünmediğini doğrulayın
        ReusableMethods.waitForSecond(3);
        Assert.assertTrue(P14_VendorRegisterPage.passwordStrength.getText().contains("Strong"));
