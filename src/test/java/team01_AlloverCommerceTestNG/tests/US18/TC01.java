...
public class TC01 extends ReusableMethods {
    ...
    private final String testName = "US18 / TC01-Code Text Box";
    private final String description = "Data must be entered in the Code text box.(PASSED)";
    private final String reportMessage = "It has been verified that data can be entered in the Code text box.";
    ...
    public void tc01() {
        ...
        codeBox.sendKeys(ConfigReader.getProperty("code"));
        extentTest.info("Code section is filled.");

        Assert.assertEquals(p20VendorCouponsPage.codeBox.getAttribute("value"),ConfigReader.getProperty("code"));
