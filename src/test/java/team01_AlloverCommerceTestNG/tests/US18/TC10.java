...
public class TC10 extends ReusableMethods {
    ...
    private final String testName = "US18 / TC10-Coupon Expiry Date";
    private final String description = "A date earlier than today cannot be entered in the Coupon expiry date field.(FAILED)";
    private final String reportMessage ="It has been determined that a date earlier than today cannot be entered in the Coupon expiry date field, but it can be entered. ";
    ...
    public void tc01() {
        ...
        String couponExpireDateData = "2020-05-07";
        p20VendorCouponsPage.expiryDate.sendKeys(couponExpireDateData);
       ...
       extentTest.fail("It has been checked whether a date earlier than today can be entered in the Coupon expiry date field..");
        ...
        try {
            ...
            extentTest.fail( "<span style='color:red; font-weight:bold; font-size: 16px'>BUG FOUNDED: &#x1F41E</span><br><span style='color:purple; font-size: 16px'>" + reportMessage + "</span>");
        }
        Driver.closeDriver();
    }
}