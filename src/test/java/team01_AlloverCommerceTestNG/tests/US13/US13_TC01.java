...
public class US13_TC01 {
    ...
    public void test01() {
      ...
      //ReusableMethods.scroll(p15VendorAddressesPage.wishlistShipping);
        //p15VendorAddressesPage.shippingAddressEdit.submit();
...
//        p15VendorAddressesPage.shippingCityName.sendKeys(Keys.DELETE);
        ...
        //p15VendorAddressesPage.shippingSaveButton.submit();
